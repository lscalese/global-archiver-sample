...
# Generate IRIS archive server certificate
GenIrisInstanceCertificate "/C=BE/ST=Wallonia/L=Namur/O=Community/OU=IT/CN=archive" "./certificates/archive_server" "./certificates/CA_Server"
